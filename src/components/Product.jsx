...
const slides = [
  {
    ...
    name: "Ecommerce Branding Platform",
    loading: "eager",
  },
  {
    mainImg: assets.interiordesign,
    cardImg: assets.aidevelopment_bg,
    logo: assets.aidevelopment_logo,
    field: "AI & ML",
    name: "Interior Design: Qubitnet AI",
    loading: "eager",
  },
  {
    mainImg: assets.dataanalytics_product,
    cardImg: assets.nocode_bg,
    logo: assets.nocode_logo,
    field: "No code solution",
    name: "BizAssist Pro",
    loading: "eager",
  },
];
    ...
    >
      ...
      <div className="max-md:h-2/5 h-full max-md:w-full md:w-[400px] lg:w-[600px] xl:w-[700px] rounded-2xl overflow-hidden relative flex flex-col">
        ...
        <div className="relative w-full h-full bg-black/40 flex max-md:flex-row flex-col items-center max-md:items-start max-md:py-3 justify-center gap-4 max-md:gap-2 max-md:px-3.5">
          ...
          <button
            type="button"
            className="bg-[#fbb039] px-2 py-1 rounded-full max-md:w-20 w-1/2 max-md:p-1 max-md:text-[12px] mb-3 font-medium hover:w-1/3 transition-all duration-300 hover:bg-[#fbb039]/90 focus:w-1/3 focus:bg-[#fbb039]/90"
...
function Product() {
  ...
  const handleExploreClick = () => {
    navigate(`/product#product-${index}`);
  };
