...
function HeroPage() {
  ...
  return (
    <div ref={heroRef} className="w-full overflow-hidden xl:p-8">
      <div className="h-full w-full flex flex-col items-center justify-center p-2 mt-3.5 xl:mt-0 gap-10 xl:flex-row">
          ...
          <div className="w-full h-full flex flex-col items-center justify-center gap-3 md:gap-6">
            ...
            <div className="flex items-center justify-center gap-4 mt-3">
              <Button
                ...
                radius="md"
                variant="faded"
                className="text-sm px-3 sm:text-lg sm:py-3 sm:px-4 lg:py-6 lg:text-xl lg:px-6 xl:px-3 xl:text-lg xl:py-3 2xl:px-6 2xl:py-5 2xl:text-xl bg-[#f73d5c] text-white border-[#f73d5c] data-[hover=true]:!bg-white data-[hover=true]:!text-black active:!text-black active:!bg-white active:transition-all active:duration-150 "
              >
                View All Services
              </Button>
              <Button
                ...
                radius="md"
                variant="ghost"
                className="text-sm px-3 sm:text-lg sm:py-3 sm:px-4 lg:py-6 lg:text-xl lg:px-6 xl:px-3 xl:text-lg xl:py-3 2xl:px-6 2xl:py-5 2xl:text-xl data-[hover=true]:!bg-[#f73d5c] data-[hover=true]:!text-white border-[#f73d5c]
                active:!bg-[#f73d5c] active:!text-white active:transition-all active:duration-150"
              >
                Contact Us
              </Button>
            </div>
        ...
        <div className="w-full h-full flex items-center justify-center">
          <div className="aspect-square w-[100%] sm:w-[80%] lg:w-[65%] xl:w-[90%] xl:p-10 p-1 relative flex items-center justify-center left-[40%] xl:left-[45%]">
            ...
            <div className="absolute w-full h-full flex justify-center z-30">
